...
public class MarketData   
{
    ...
    public MarketData(List<Good> goods, List<AgentData> agentTypes, List<BasicAgent> agents) throws Exception {
        this.goods = goods;
    ...
    /**
    	     ...
    	     * @param	json		the JSON file definition for your Market
    	     * @param	getAgent	a function to create agents
    	     */
    public static MarketData fromJSON(String json, BasicAgent getAgent) throws Exception {
        return null;
    }
