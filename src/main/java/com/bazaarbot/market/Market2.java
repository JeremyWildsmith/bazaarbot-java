...
public class Market2 extends Market {
    ...
    public Market2(MarketData marketData, ISignalBankrupt bankrupt, IOfferResolver offerResolver, IOfferExecuter executor) {
        super("test", marketData, bankrupt, offerResolver, executor);
    }
    ...
    public void startSession(int rounds, Runnable callback) {
    ...
    private void sessionRound(IContractResolver contractResolver) {
        ...
        for (Offer bidOffer : providedBids) {
            ...
            //System.out.println("BID: " + bidOffer);
            ...
            for (Offer askOffer : interestedAsks) {
                //System.out.println("ASK: " + askOffer);
                ...
                if (success) {
                    System.out.println("!!!! SUCCESS !!! Bid: " + bidOffer +" Ask: "+ askOffer);
    ...
    private boolean tryDeal(Offer bidOffer, Offer askOffer, ICommodity good, IContractResolver contractResolver) {
        ...
        IContract contract = contractResolver.newContract(seller, buyer, askOffer.getGood(), quantityTraded, negotiatedPrice);
        ...
        buyer.updatePriceModel("buy", good, true, negotiatedPrice / quantityTraded);
        seller.updatePriceModel("sell", good, true, negotiatedPrice / quantityTraded);
